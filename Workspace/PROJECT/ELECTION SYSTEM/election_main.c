#include <stdio.h>
#include <string.h>
void castvote(int,int,int,int);
void votesCount(int,int,int,int);
void votesResult(int,int,int,int);
...
int main()
{
    ...
    do
    {
        ...
        {
        case 1:
            castvote(votescount1,votescount2,votescount3,votescount4);
            break;
        case 2:
            votesCount(votescount1,votescount2,votescount3,votescount4);
            break;
        case 3:
            votesResult(votescount1,votescount2,votescount3,votescount4);
            break;
        default:
